    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1> Edit Appointment #{{ $edit->id }} </h1>
                <hr />
            </div>
        </div>

        <div class='col-md-12'>
            <form method='POST' action='/admin/appointment/{{ $edit->id }}'>
                {{ csrf_field() }}
               ...
               <div class="form-group">
                  ...
                  <select class="form-control" id="complete" name='complete' >
                      <option value="{{ $edit->complete }}"> {{ $edit->complete == 0 ? 'No' : 'Yes' }} </option>
                ...
                <a href='/admin/appointments' class='btn btn-danger'> Cancel </a>
            </form>
        </div>
    </div>
@endsection
